...
```{r}
plot(performance_dual_uplift_bogo, type = "b", lwd = 1, col="blue4")
```
...
```{r}
barplot(performance_dual_uplift_bogo, col="blue4")
```

## Conclusão:

Apesar de as campanhas de marketing voltadas para promoção de disconto terem um resultado cumulativo melhor as campanhas de BOGO apresentam um desempenho uplift melhor, assim é necessário menor volume para um mesmo resultado para populações menores de marketing.
